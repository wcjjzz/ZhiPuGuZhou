  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-900/18 p-4 backdrop-blur-sm lg:p-6">
      <motion.div
        ...
        className="flex max-h-[92vh] w-full max-w-5xl flex-col overflow-hidden rounded-[34px] border border-white/80 bg-white/95 p-5 shadow-[0_40px_100px_rgba(94,124,116,0.22)] lg:p-6"
      >
        ...
        <div className="mt-5 min-h-0 flex-1 overflow-y-auto pr-1">
          <div className="grid gap-5 xl:grid-cols-[0.9fr_1.1fr]">
            <div className="space-y-4">
              <div className="rounded-[28px] bg-gradient-to-br from-amber-50 via-white to-rose-50 p-5">
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  ...
                  <Tag className="bg-white text-slate-500">当前共 10 张图片卡</Tag>
                </div>
              </div>

              <div className="max-h-[420px] overflow-y-auto rounded-[24px] bg-slate-50 p-3">
            ...
            <div className="space-y-4">
              <div className={`rounded-[30px] bg-gradient-to-br ${picked.accent} p-4`}>
              ...
              <div className="rounded-[30px] bg-slate-50 p-5">
                ...
                <div className="mt-4 flex max-h-[132px] flex-wrap gap-2 overflow-y-auto pr-1">
        ...
        <div className="mt-5 flex shrink-0 justify-end gap-3 border-t border-slate-100 pt-4">
